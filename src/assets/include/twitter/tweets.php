...
if( isset( $_GET['username'] ) AND $_GET['username'] != '' ):
	...
	$consumerkey = "205ns1kuGq1FTfTd8sl6ZVLX9";
	$consumersecret = "A6uNjxHhUvQAWm1KY4DLvWrue3a1XiRWrh1ALTcH9DUCuQcM8H";
	$accesstoken = "18933341-q4umSS8TTVH8cnC5fMaCV10S9MP9d4q3CXPu2IgGJ";
	$accesstokensecret = "Dx7USVZsuRoYhetgxN30Jp0ydyK8fcjUJhfzikmGQYYuW";
